<?php
//link
$qyuk2 = mysqli_query($koneksi, "SELECT * FROM cp_m_mitra ".
						"ORDER BY nama ASC");
...
do
    ...
    echo '<p>
    <a href="http://'.$yuk2_urlnya.'" target="_blank"><img src="'.$sumber.'/filebox/mitra/'.$yuk2_kd.'/'.$yuk2_filex.'" width="100%" height="100"></a>
    </p>';
	}
