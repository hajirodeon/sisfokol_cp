...
if ($_POST['btnSMP'])
	...
	$e_oleh = cegah($_POST['e_oleh']);
	

	//nek null
	if ((empty($e_isi)) OR (empty($e_oleh)))
		{
		//re-direct
...
if (($s == "baru") OR ($s == "edit"))
	...
	<input name="e_isi" type="text" size="50" value="'.$e_isi.'" class="btn-warning">
	</p>
	...
	<input name="e_oleh" type="text" size="30" value="'.$e_oleh.'" class="btn-warning">
	</p>
	...
	$sqlcount = "SELECT * FROM cp_katamutiara ".
					"ORDER BY isi ASC";
	$sqlresult = $sqlcount;
	...
	<td width="16">&nbsp;</td>
	<td width="30">&nbsp;</td>
	<td><strong><font color="'.$warnatext.'">Kata Mutiara</font></strong></td>
	<td width="150"><strong><font color="'.$warnatext.'">Oleh</font></strong></td>
	</tr>
