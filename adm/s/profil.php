...
Judul : 
<br>
<input name="e_nama" type="text" size="20" value="'.$ku_judul.'" class="btn btn-warning">
</p>
...
Sekilas Sekolah : 
<br>
<input name="e_isi" type="text" size="50" value="'.$ku_isi.'" class="btn btn-warning">
</p>
...
Fax : 
<br>
<input name="e_fax" type="text" size="20" value="'.$ku_fax.'" class="btn btn-warning">
</p>
...
FB : 
<br>
<input name="e_fb" type="text" size="30" value="'.$ku_fb.'" class="btn btn-warning">
</p>
...
Twitter : 
<br>
<input name="e_twitter" type="text" size="30" value="'.$ku_twitter.'" class="btn btn-warning">
</p>
...
Youtube : 
<br>
<input name="e_youtube" type="text" size="30" value="'.$ku_youtube.'" class="btn btn-warning">
</p>

<p>
WA : 
<br>
<input name="e_wa" type="text" size="30" value="'.$ku_wa.'" class="btn btn-warning">
</p>
...
Instagram : 
<br>
<input name="e_instagram" type="text" size="30" value="'.$ku_instagram.'" class="btn btn-warning">
</p>
...
Alamat Google Map : 
<br>
<input name="e_alamat2" type="text" size="30" value="'.$ku_alamat2.'" class="btn btn-warning">
</p>
