...
//nilai
$filenya = "link_internal.php";
$judul = "[SETTING] Data Link Internal";
$judulku = "$judul";
$judulx = $judul;
...
$sqlcount = "SELECT * FROM cp_link_internal ".
				"ORDER BY nama ASC";
$sqlresult = $sqlcount;
...
if (($s == "baru") OR ($s == "edit"))
	...
	URL : 
	<br>
	<input name="e_isi" type="text" value="'.$e_isi.'" size="50" class="btn btn-warning">
	</p>
